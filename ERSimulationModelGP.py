...
Outputs (100 replications, 95% CI):
  ...
  - Results/simulation/gp/ED_output_analysis.png
  - Results/simulation/gp/ED_utilisation.png
  - Results/simulation/gp/ED_gp_posterior.png
  - Results/simulation/gp/ED_rep_results.csv
...
Outputs : Results/simulation/gp/*.png,  Results/simulation/gp/ED_rep_results.csv
"""
...
RESULTS_DIR = os.path.join(BASE_DIR, "Results", "simulation", "gp")
